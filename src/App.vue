                ...
                <ul class="nav navbar-nav ml-auto" id="menu-v8">
                    ...
                    <li class="nav-item" role="presentation">
                      <!-- REEMPLAZAR CON ELEMENTO ROUTER LINK A RUTA ESTÁTICA -->
                       <router-link to="/post">último post</router-link>
                    </li>
                </ul>
        </div>
        </div>
...
/* para hacer la transicion opacidad */
.transicion-enter-active, .transicion-leave-active {
transition: opacity 0.1s;
}
.transicion-enter, .transicion-leave-to{
opacity: 0;
}
</style>
